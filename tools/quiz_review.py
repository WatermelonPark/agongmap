...
review(검토 기한)를 달고, 기한이 지난 문항을 감시(check_freshness)가 경고(::warning::·잡 요약)로, 배치 기록이
ℹ️ 줄(batch_notes.quiz_review_lines — 월요일 확인 메일)로 올린다. 실패로 올리면 감시가 매일 빨개져 진짜 뒤처짐
경보가 묻힌다(2026-09-26 데이터 감사 #13).
